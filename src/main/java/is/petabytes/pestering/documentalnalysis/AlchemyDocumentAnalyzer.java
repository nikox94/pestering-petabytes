...
@Service
public class AlchemyDocumentAnalyzer {
	...
	public static void strain() {
		...
		new AlchemyDocumentAnalyzer();
		final List<EntitySentiment> res = AlchemyDocumentAnalyzer.analyze(title, content, observedList);
